...
# Begin
logging.info("Starting script to fetch " + year1 + " ERA5 Z data at 200 hPa")
...
with dask.config.set(array__slicing__split_large_chunks=True):
    ...
    logging.info("Slicing 200 hPa...")
    z850 = z.sel(level=200)
    ...
    z850daily.to_netcdf(path = 'z200daily' + year1 + '.nc')
